...
## 2. Learning Units And Senses

The tracked learning unit is:
...
## 3. Active And Recognition Vocabulary

Collect and store whether each sense is:
...
The learner should produce the word in Writing or Speaking. Active units require
spelling, grammar, collocation, and productive-context questions.

### Recognition

The learner mainly needs to understand the word in Reading or Listening.
Recognition units prioritize meaning choice, definition matching, listening
recognition, and contextual comprehension.

### Both

The word is useful for both production and comprehension.

The default automatic practice mix must use this classification:

- Active: include productive and recognition questions.
- Recognition: primarily use recognition questions.
- Both: balanced mix adjusted by learner performance.

TODO: add a setting that lets learners enable or disable question categories,
including spelling, listening, speaking, reading, and writing. Default mode is
`Auto`, which selects a personalized mix based on active/recognition status,
mistakes, response speed, and review due dates.

## 4. Level Composition

Each level represents approximately 80 learning/practice placements, not 80
entirely new headwords.

Recommended composition:

| Band | New headword/sense units | Forms/collocations | Review/context reuse |
|------|--------------------------|--------------------|----------------------|
| 4.0-5.0 | 45 | 5 | 30 |
| 5.5-6.5 | 50 | 10 | 20 |
| 7.0-8.0 | 55 | 15 | 10 |

The current target of approximately 12,530 approved units is sufficient for the
...
Each topic or unit must reserve part of its practice mix for cross-topic words
...
- Assign these units primarily by difficulty and function.
...
- A later distinct sense or collocation may count as a new learning unit.
...
- Whether the sense is active, recognition, or both.
...
- Oxford/source joins.
- Sense separation.
- Active/recognition classification.
