...
weight_kg <-    # Overwrites your object. Be careful! no warning is given
...
Myvector1  # c for combine/concatenate
Myvector2 <-  
Myvector3 <- 
...
days
days[] # to extract element 3. R indexes from 1, not 0. -1 will not get the last value, it excludes that item
days[-1]
days[]
...
# view structure of data; very useful function!
 ...
 # check to see that test is what we expect it to be
